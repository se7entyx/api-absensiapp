...
<body>
    <div class="container">
        ...
        <h3><strong>SURAT PERMOHONAN IJIN KELUAR</strong></h3>
        <div class="form-content">
            ...
            <div class="form-content">
                <div class="form-row">
                    ...
                    <input type="text" value="{{ $izin->user->name }}">
                </div>
            </div>
            ...
            <div class="form-row">
                <span class="label">TANGGAL </span> <span class="titikdua">:</span> <input type="text"
                    value="{{ \Carbon\Carbon::parse($izin->created_at)->format('d-m-Y') }}">
            </div>
            ...
            <div class="form-row">
                <span class="label">KEMBALI </span> <span class="titikdua">:</span>
                <div class="checkbox-group">
                    <input type="checkbox" {{ $izin->kembali == 'ya' ? 'checked' : '' }}> KEMBALI
                </div>
                <div class="checkbox-group">
                    <input type="checkbox" {{ $izin->kembali == 'tidak' ? 'checked' : '' }}> TIDAK
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <input type="text" class="jam"
                    value="{{ \Carbon\Carbon::parse($izin->waktu_keluar)->format('H:i') }}">
                <span class="label" style="margin-left: 50px;">JAM DATANG :</span>
                <input type="text" class="jam"
                    value="{{ \Carbon\Carbon::parse($izin->waktu_kembali)->format('H:i') }}">
                @else
                <span class="label">JAM KELUAR :</span>
                <input type="text" class="jam"
                    value="{{ \Carbon\Carbon::parse($izin->waktu_keluar)->format('H:i') }}">
                <span class="label" style="margin-left: 50px;">JAM KEMBALI :</span>
                <input type="text" class="jam"
                    value=" - ">
                    @endif
            </div>
