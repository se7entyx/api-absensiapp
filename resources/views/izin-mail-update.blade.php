                            ...
                            <table cellspacing="0" cellpadding="0" style="margin: auto;">
                                <tr>
                                    <td style="background-color: #345C72; padding: 10px 20px; border-radius: 5px; text-align: center;">
                                        <a href="http://api-absensiapp.test:8080/izin/ongoing/" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold;">Lihat Data</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
