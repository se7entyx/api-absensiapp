                ...
                <table class="content" width="600" style="border-collapse: collapse; border: 1px solid #cccccc;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="body" style="padding: 40px; text-align: left; font-size: 16px; line-height: 1.6;">
                            ...
                            @endif
                            <br></br>
                            Klik tombol dibawah untuk melihat progress pengajuan {{$msg->user->name}}
                        </td>
                    </tr>
                            ...
                            <table cellspacing="0" cellpadding="0" style="margin: auto;">
                                <tr>
                                    <td style="background-color: #345C72; padding: 10px 20px; border-radius: 5px; text-align: center;">
                                        <a href="https://api-absensiapp-production.up.railway.app/cuti/ongoing/" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold;">Lihat Data</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
