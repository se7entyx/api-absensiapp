<x-layout title="New Cuti">
    ...
    <section class="bg-gray-100  w-full px-4 py-4 sm:px-6">
        ...
        <form action="{{ route('cuti.update',$cuti->id)}}" method="post" class="xl:px-32">
            @method('PUT')
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea id="keterangan" rows="4" name="keterangan" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukan keterangan" required>{{$cuti->keterangan}}</textarea>
            </div>
            <div class="mb-6">
                <label for="start_date" class="block mb-2 text-sm font-medium text-gray-900">Start Date</label>
                <input type="date" id="start_date" name="start_date" required
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{$cuti->start_date}}">
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="date" id="end_date" name="end_date" required
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{$cuti->end_date}}">
            </div>
            <div class="mb-6">
                ...
                <input type="text" id="total_days" name="total_days" readonly
                    class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{$cuti->jumlah_hari}}">
            </div>
