<x-layout title="New Izin">
    @section('title', 'New Izin')
    ...
    <section class="bg-gray-100  w-full px-4 py-4 sm:px-6">
        ...
        <form action="{{ route('izin.store')}}" method="post" class="xl:px-32">
            @csrf
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center">
                        <input type="radio" name="kembali" value="ya" class="kembali-radio text-blue-600" required>
                        <span class="ml-2 text-gray-900">Ya</span>
                    </label>
                    <label class="flex items-center">
                        <input type="radio" name="kembali" value="tidak" class="kembali-radio text-blue-600">
            ...
            <!-- Waktu Kembali -->
            <div id="waktu_kembali_container" class="mb-6 hidden">
