        ...
        <form method="GET" action="{{ route('cuti.rekap') }}">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('cuti.rekap') }}" class="w-full">
                        <button type="button"
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
                ...
                <tbody>
                    <tr class="bg-white border-b hover:bg-gray-50 ">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                            {{ \Carbon\Carbon::parse($cuti->end_date)->format('d M Y, H:i') }}
                        </td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                            {{ $cuti->keterangan }}
                        </td>
                        ...
                        <td class="px-6 py-4 flex space-x-3">
                            ...
                            @endif
                            @if (($cuti->status === 'acc-1' || $cuti->status === 'acc-2' ) && $cuti->user_id === Auth::id())
                            <a href="{{route('cuti.edit',$cuti->id)}}">
                                <button class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center " type="button">
                                    Edit
                                </button>
                            ...
                            @endif
                            @if (($cuti->status === 'acc0' || $cuti->status === 'acc-1' || $cuti->status === 'acc-2') && $cuti->user_id === Auth::id())
